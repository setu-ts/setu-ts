...
npm install jsr:@setu-ts/kernel@^0.7.0
npm install jsr:@setu-ts/runtime@^0.7.0
npm install jsr:@setu-ts/common@^0.7.0
```
...
```json
{
  ...
  "imports": {
    "@setu-ts/kernel": "jsr:@setu-ts/kernel@^0.7.0",
    "@setu-ts/runtime": "jsr:@setu-ts/runtime@^0.7.0",
...
# Add Setu-TS packages
bun add jsr:@setu-ts/kernel@^0.7.0
bun add jsr:@setu-ts/runtime@^0.7.0
bun add jsr:@setu-ts/common@^0.7.0
```
...
# Add Setu-TS packages
npm add jsr:@setu-ts/kernel@^0.7.0
npm add jsr:@setu-ts/runtime@^0.7.0
npm add jsr:@setu-ts/common@^0.7.0
```
