...
npm install jsr:@setu-ts/kernel@^0.1.0-alpha.7
npm install jsr:@setu-ts/runtime@^0.1.0-alpha.7
npm install jsr:@setu-ts/common@^0.1.0-alpha.7
```
...
```json
{
  ...
  "imports": {
    "@setu-ts/kernel": "jsr:@setu-ts/kernel@^0.1.0-alpha.7",
    "@setu-ts/runtime": "jsr:@setu-ts/runtime@^0.1.0-alpha.7",
    "@setu-ts/common": "jsr:@setu-ts/common@^0.1.0-alpha.7"
  }
}
```
...
# Add Setu-TS packages
bun add jsr:@setu-ts/kernel@^0.1.0-alpha.7
bun add jsr:@setu-ts/runtime@^0.1.0-alpha.7
bun add jsr:@setu-ts/common@^0.1.0-alpha.7
```
...
# Add Setu-TS packages
npm add jsr:@setu-ts/kernel@^0.1.0-alpha.7
npm add jsr:@setu-ts/runtime@^0.1.0-alpha.7
npm add jsr:@setu-ts/common@^0.1.0-alpha.7
```
