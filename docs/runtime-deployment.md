...
npm install jsr:@setu-ts/kernel@^0.1.0-alpha.6
npm install jsr:@setu-ts/runtime@^0.1.0-alpha.6
npm install jsr:@setu-ts/common@^0.1.0-alpha.6
```
...
# Add Setu-TS packages
bun add jsr:@setu-ts/kernel@^0.1.0-alpha.6
bun add jsr:@setu-ts/runtime@^0.1.0-alpha.6
bun add jsr:@setu-ts/common@^0.1.0-alpha.6
```
...
# Add Setu-TS packages
npm add jsr:@setu-ts/kernel@^0.1.0-alpha.6
npm add jsr:@setu-ts/runtime@^0.1.0-alpha.6
npm add jsr:@setu-ts/common@^0.1.0-alpha.6
```
