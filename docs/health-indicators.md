...
| 21 | `cqrs`               | cqrs-plugin               | `packages/cqrs-plugin/src/plugin/cqrs-plugin.ts:133`                            | `configuration-literal` | `status: 'up'` beside live `data.commands`/`queries` handler counts. In-process bus, no backend.                                                                                                                                      |
| 22 | `events`             | events-plugin             | `packages/events-plugin/src/plugin/events-plugin.ts:136`                        | `configuration-literal` | `status: 'up'` beside live `data.handlers`. In-process bus, no backend.                                                                                                                                                               |
