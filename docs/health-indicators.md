...
| 22 | `events`             | events-plugin             | `packages/events-plugin/src/plugin/events-plugin.ts:147`                        | `configuration-literal` | `status: 'up'` beside live `data.handlers`. In-process bus, no backend.                                                                                                                                                               |
