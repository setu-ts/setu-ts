...
| -------- | -------------------------------------------------- | -------- | ---- | ---------------------------------------------------------------------- |
| **M90a** | Abuse control that actually protects               | 6        | 3    | common, auth, http-security, runtime, graphql, logger, metrics         |
...
DELETES two duplicates rather than creating a fifth (§11.1).
