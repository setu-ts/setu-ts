...
const TYPE_EXPORTS: Readonly<Record<string, string>> = {
  ...
  GrpcServiceDefinition: '@setu-ts/common',
...
const APP_DECLARATIONS: Readonly<Record<string, string>> = {
  ...
  myInterceptor: 'declare const myInterceptor: unknown',
  isValid: 'declare function isValid(token: unknown): boolean',
  userFor: 'declare function userFor(token: unknown): unknown',
  tickStream: 'declare function tickStream(): AsyncIterable<{ tick: number }>',
  typeDefs: 'declare const typeDefs: string',
  resolvers: 'declare const resolvers: ResolverMap',
