 ...
 *
 * The bytes are revived at runtime with `createFileRegistry(fromBinary(...))` from
 * `@bufbuild/protobuf` (see {@linkcode ConnectRuntime.reviveDescriptorSet}). A unit
 * test decodes each constant and asserts the expected service name, so a truncated
 * or swapped constant fails loudly instead of degrading into an empty router.
 *
 * **Important:** These constants must be kept in sync with the actual proto
 * definitions from the upstream grpc/grpc-proto repository. Regenerate using the
 * command recorded in JSDoc if the protos change.
 *
 * @module
 */
...
// Base64 length: 1168 chars (from 874 bytes), generated 2026-08-01 with protoc 35.1.
//
...
export const healthBase64: string =
  '';
...
// Source: grpc/grpc-proto, https://github.com/grpc/grpc-proto
// Command: protoc -I. --include_imports \
//   --descriptor_set_out=grpc/reflection/v1/reflection.binpb \
//   grpc/reflection/v1/reflection.proto
// Base64 length: 2332 chars (from 1747 bytes), generated 2026-08-01 with protoc 35.1.
//
