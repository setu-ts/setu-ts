...
describe('HttpCollector', () => {
  it('middleware priority is 20', () => {
    assertEquals(MIDDLEWARE_PRIORITY.METRICS, 20);
  });

  it('registers four HTTP metrics', () => {
  ...
  it('middleware records duration and request count for 200', async () => {
    const service = new MetricsService();
    const runtime = new FakeRuntime();
    const collector = new HttpCollector(service, runtime);
  ...
  it('middleware records error for 500', async () => {
    const service = new MetricsService();
    const runtime = new FakeRuntime();
    const collector = new HttpCollector(service, runtime);
  ...
  it('active gauge returns to baseline after request', async () => {
    const service = new MetricsService();
    const runtime = new FakeRuntime();
    const collector = new HttpCollector(service, runtime);
  ...
  it('duration uses monotonic clock', async () => {
    const service = new MetricsService();
    const runtime = new FakeRuntime();
    const collector = new HttpCollector(service, runtime);
  ...
  it('throw path rethrows and records metrics', async () => {
    const service = new MetricsService();
    const runtime = new FakeRuntime();
    const collector = new HttpCollector(service, runtime);
