...
Deno.test('MetricsRegistry — insert/get/iterate', () => {
...
Deno.test('MetricsRegistry — duplicate name with conflicting type throws', () => {
  const registry = new MetricsRegistry();
...
Deno.test('MetricsRegistry — same name + same type is idempotent', () => {
  const registry = new MetricsRegistry();
  const config: MetricConfig = {
    type: 'counter',
    help: 'Test',
...
Deno.test('MetricsRegistry — entries iterator', () => {
  const registry = new MetricsRegistry();
...
Deno.test('MetricsRegistry — names array', () => {
  const registry = new MetricsRegistry();
...
Deno.test('MetricsRegistry — size', () => {
  const registry = new MetricsRegistry();
  const config: MetricConfig = { type: 'counter', help: 'Test' };
...
Deno.test('MetricsRegistry — clear', () => {
  const registry = new MetricsRegistry();
  const config: MetricConfig = { type: 'counter', help: 'Test' };
