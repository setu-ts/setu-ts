 ...
 * Provides a minimal `runtime` (with `env` and a monotonic `hrtime`) registered under
 * `CAPABILITIES.RUNTIME`, and captures registrations, health indicators, close handlers.
 *
 * @module
 */
 ...
 * @param fs - Optional file-system service for LocalStorageProvider tests
