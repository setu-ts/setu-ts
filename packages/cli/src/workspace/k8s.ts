...
Generated by \`setu generate app\` — one Deployment and one Service per member, regenerated whenever a
member is added.

\`\${NAMESPACE}\` and \`\${WORKSPACE}\` are placeholders, not shell variables: fill them in, or pipe the
file through \`envsubst\`:
