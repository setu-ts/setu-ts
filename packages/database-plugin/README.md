...
| `createInjectedClientLoader`       | function  |
| `createLazyClientLoader`           | function  |
| `createMongoDataSource`            | function  |
| `createPrismaDataSource`           | function  |
| `DatabasePlugin`                   | function  |
| `escapeRegex`                      | function  |
| `fromDriverDocument`               | function  |
| `getDrizzleDatabase`               | function  |
| `getDrizzleTransaction`            | function  |
| `parseDatabaseFromUrl`             | function  |
| `resolveMongoTarget`               | function  |
| `toDriverDocument`                 | function  |
| `toDriverId`                       | function  |
| `toIdString`                       | function  |
| `translateCountFilter`             | function  |
