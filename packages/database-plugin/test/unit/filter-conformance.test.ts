 ...
 * agreeing with a fake engine proves nothing. The same case table is instead
 * run against the REAL service, with the same Memory-adapter reference answer,
 * in `test/integration/real-cosmos-adapter.test.ts`.
 *
