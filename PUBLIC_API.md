...
| gRPC                | `IGrpcService`, `GrpcServiceDefinition`, `ServiceImpl` (**deprecated** — `addService`'s `implementation` is now `unknown`, so a class instance is accepted; nothing reads this type), `GrpcServingStatus`, `RpcFetchHandler`                                                                                                                                                                                              |
