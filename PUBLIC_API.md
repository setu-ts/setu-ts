...
| `maxNodes`           | `number`                                  | `0`        | Maximum fields a document may **resolve**, counting every alias separately and expanding each fragment spread at its spread site. **`0` (the default) is unbounded** |
