...
- **Milestone 36** (`packages/starters/rest-starter`, `packages/starters/microservice-starter`,
   `packages/starters/full-stack-starter` — opinionated plugin composition libraries: `createRestApp`,
   `createMicroserviceApp`, `createFullStackApp` with pre-wired plugin sets, option arms, and Workers-
   portability documentation) — complete (PR #100)
...
- **Next milestone** — **Milestone 37** (example applications); M38 follow unless
   reprioritized.
