...
| `database-plugin/test/unit/{drizzle,prisma,mongo,cosmos,dynamo}-adapter.test.ts` (extended) | the seven sites                 | Each site's thrown error carries the injected driver failure as `cause`, and `serializeError` reports it at depth 1 with its `code`.                                                                                                                                                                                                                          |
