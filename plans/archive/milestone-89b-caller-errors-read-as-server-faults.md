...
| `ROADMAP.md`, `CLAUDE.md`                                                           | Status flip (ROADMAP row + heading, CLAUDE.md entry). **CORRECTION:** C1 needed no edit — verified against both files, PR #234 already shipped the `403` → `501` wording.                                                                                                                                                                                                                 |
