...
| ROADMAP milestone list         | `ROADMAP.md:4901` (M50), `ROADMAP.md:5145-5211`                                          | Before this milestone the highest section was 50 and the Progress table's last row was `50` — the M36b defect class. Both were written in the planning commit: the M51 and M51b sections, and `⬜` rows for each. Flipping `51` to `✅` with the PR number remains a deliverable of the implementation PR. |
...
| -- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| C1 | `ROADMAP.md` had no M51 section and no `51` Progress row, while this milestone was being planned. Identical to the M36b defect, which shipped with neither.                                               | The ROADMAP is the milestone register; a milestone without a section there is unreviewable, and a deferral recorded only in a plan file is a deferral that gets lost. Written **at planning time** rather than at PR time, so the M51b split is registered before any code exists. | Done in the planning commit: `## Milestone 51` and `## Milestone 51b` sections after M50, plus `⬜` Progress rows for both. The implementation PR flips row `51` to `✅` with its PR number.                                                |
